...
console.log(JSON.stringify({
    ...
    const handleRegister = async () => {
      ...
      try{
        ...
        body.append("organisation", organization)
        let response = await fetch(`${API_BASE_URL}/registration`, {
             method: 'POST',
             headers: {
  ...
  try {
    ...
    return (
        ...
        <View style={{flex: 1, backgroundColor: 'white', justifyContent: 'center',}}>
            ...
            <Text style={{ fontSize: ts(14), color: colorText, fontWeight: '400', marginBottom: 8 }}>ФИО (полностью)</Text>
            <TextInput
            ...
            <Text style={{ fontSize: ts(14), color: colorText, fontWeight: '400', marginBottom: 8 }}>Email</Text>
            <TextInput
                style={[styles.input, {fontSize: ts(14), color: colorTextBorder, borderColor: colorTextBorder}]}
                value={email}
            ...
            <Text style={{ fontSize: ts(14), color: colorText, fontWeight: '400', marginBottom: 8 }}>Пароль</Text>
            <TextInput
                style={[styles.input, {fontSize: ts(14), color: colorTextBorder, borderColor: colorTextBorder}]}
                secureTextEntry
                value={password}
            ...
            />
            <Text style={{ fontSize: ts(14), color: colorText, fontWeight: '400', marginBottom: 8 }}>Подтвердите пароль</Text>
            <TextInput
                style={[styles.input, {fontSize: ts(14), color: colorTextBorder, borderColor: colorTextBorder}]}
                secureTextEntry
            ...
            <View style={{flexDirection: 'row', width: '100%', alignContent: 'center', paddingBottom: '2%'}}>
                ...
                <Checkbox
                                ...
                                color={isSelected ? colorTextVersion: colorTextBorder}//undefined
                                style={{alignSelf: 'center'}}
                            /></View>
                
                    <Text style={{ color: colorTextVersion, fontSize: ts(14), lineHeight: 20 }}>
                    Я даю своё{' '}
                    <Text 
                        style={{ color: colorTextVersion, textDecorationLine: 'underline' }} 
             ...
             <View style={{ paddingBottom: BOTTOM_SAFE_AREA + 8.5 }}>
                ...
                disabled={disabled}
                    ...
                    <View style={[styles.container, {width: '96%', alignSelf: 'center'}]}>
                        <Text style={{ fontSize: ts(16), fontWeight: 500, textAlign: 'center', color: colorText  }}>
                        Политика конфиденциальности
 в отношении обработки персональных данных
приложения «Планшет ПНР»{"\n"}

                        </Text>
                        <Text style={{ fontSize: ts(14), fontWeight: 500, color: colorText }}>
1. Общие положения
                        </Text>
                        <Text style={{ fontSize: ts(14) , color: colorText}}>
