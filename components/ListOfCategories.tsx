        ...
        <View style={{width: '96%'}}>
            <View style={styles.container}>
                ...
                <View ref={dropdownRef}>
                    <TouchableOpacity
                        onPress={handleOpen}
                        style={[styles.dropdown, { borderColor: colorGray }, isFocus && { borderColor: colorBlue }]}
                    >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Text style={[styles.selectedTextStyle, { fontSize: ts(14), paddingBottom: 2, fontWeight: '500', color: colorBlue, alignSelf: 'center' }]}>
                                Категория замечания
                            </Text>
                            <Text style={[styles.selectedTextStyle, { fontSize: ts(16), paddingBottom: 14, alignSelf: 'center', color: colorGray }]}>
                                {value ? selectedLabel : 
                                                            <Text style={[styles.selectedTextStyle, { fontSize: ts(14), paddingBottom: 2,  alignSelf: 'center', color: colorGray }]}>
                                                                Не выбрано
                                                            </Text>}
                            </Text>
                            <TextInput
                                ...
                                style={[styles.inputSearchStyle, { fontSize: ts(14), color: colorText, borderColor: colorGray }]}
                                autoFocus
                            />
